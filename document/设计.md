...
| -------- | ---------------- | -------- | ------ | --------------- | ----------- | -------- |
| id       | char(19)         | NOT NULL |        | 用户id          | PRIMARY KEY |          |
...
| extracode   | varchar(128) |          | NULL   | 额外增强码                                    |             |          |
...
CREATE TABLE `user_check` (
  ...
  `extracode` varchar(128) DEFAULT NULL COMMENT '额外增强码',
...
| 字段名             | 字段类型     | 可为空   | 默认值 | 注释               | 索引类型    | 补充说明                                             |
| ------------------ | ------------ | -------- | ------ | ------------------ | ----------- | ---------------------------------------------------- |
| id                 | char(19)     | NOT NULL |        | 文件夹id           | PRIMARY KEY |                                                      |
| user_id            | char(19)     | NOT NULL |        | 用户id             | KEY         |                                                      |
...
CREATE TABLE `user_nfolder` (
  `id` char(19) NOT NULL COMMENT '文件夹id',
...
| 字段名             | 字段类型     | 可为空   | 默认值 | 注释               | 索引类型    | 补充说明                                             |
| ------------------ | ------------ | -------- | ------ | ------------------ | ----------- | ---------------------------------------------------- |
| id                 | char(19)     | NOT NULL |        | 收藏夹id           | PRIMARY KEY |                                                      |
| user_id            | char(19)     | NOT NULL |        | 用户id             | KEY         |                                                      |
...
| 字段名 | 字段类型 | 可为空   | 默认值 | 注释         | 索引类型    | 补充说明 |
| ------ | -------- | -------- | ------ | ------------ | ----------- | -------- |
| id     | char(19) | NOT NULL |        | 笔记ID       | PRIMARY KEY |          |
| text   | text     |          |        | 笔记正文内容 |             |          |
...
CREATE TABLE `note_text` (
  `id` char(19) NOT NULL COMMENT '笔记ID',
...
| ---------------- | --------------- | -------- | ------ | ----------------------------------------- | ----------- | -------- |
| id               | char(19)        | NOT NULL |        | 笔记ID                                    | PRIMARY KEY |          |
| user_id          | char(19)        | NOT NULL |        | 用户ID（发布者ID）                        | KEY         |          |
| note_folder_id   | char(19)        | NOT NULL |        | 文件夹ID                                  | KEY         |          |
...
CREATE TABLE `note_message` (
  `id` char(19) NOT NULL COMMENT '笔记ID',
  `user_id` char(19) NOT NULL COMMENT '用户ID（发布者ID）',
  `note_folder_id` char(19) NOT NULL COMMENT '文件夹ID',
...
| 字段名               | 字段类型 | 可为空   | 默认值 | 注释     | 索引类型    | 补充说明 |
| -------------------- | -------- | -------- | ------ | -------- | ----------- | -------- |
| id                   | char(19) | NOT NULL |        | ID       | PRIMARY KEY |          |
| note_id              | char(19) | NOT NULL |        | 笔记ID   | KEY         |          |
| collection_folder_id | char(19) | NOT NULL |        | 收藏夹ID | KEY         |          |
...
CREATE TABLE `note_user_collection` (
  ...
  `note_id` char(19) NOT NULL COMMENT '笔记ID',
  `collection_folder_id` char(19) NOT NULL COMMENT '收藏夹ID',
...
| 字段名         | 字段类型        | 可为空   | 默认值 | 注释                   | 索引类型    | 补充说明 |
| -------------- | --------------- | -------- | ------ | ---------------------- | ----------- | -------- |
| id             | char(19)        | NOT NULL |        | 评论ID                 | PRIMARY KEY |          |
| note_id        | char(19)        | NOT NULL |        | 笔记ID                 | KEY         |          |
| user_id        | char(19)        | NOT NULL |        | 用户ID（评论发布者ID） | KEY         |          |
| nickname       | varchar(50)     | NOT NULL |        | 用户昵称               |             |          |
| avatar         | varchar(255)    | NOT NULL |        | 用户头像               |             |          |
| content        | varchar(500)    | NOT NULL |        | 评论内容               |             |          |
| likes          | bigint unsigned | NOT NULL | 0      | 点赞数                 |             |          |
| parent_id      | char(19)        |          | NULL   | 所属评论ID             |             |          |
| reply_nickname | varchar(50)     |          | NULL   | 被回复人昵称           |             |          |
| reply_user_id  | char(19)        |          | NULL   | 被回复人ID             |             |          |
...
CREATE TABLE `note_comment` (
  `id` char(19) NOT NULL DEFAULT '' COMMENT '评论ID',
  `note_id` char(19) NOT NULL DEFAULT '' COMMENT '笔记id',
  `user_id` char(19) NOT NULL COMMENT '用户ID（评论发布者ID）',
  `nickname` varchar(50) NOT NULL COMMENT '用户昵称',
  `avatar` varchar(255) NOT NULL COMMENT '用户头像',
  `content` varchar(500) NOT NULL COMMENT '评论内容',
  `likes` bigint unsigned NOT NULL DEFAULT '0' COMMENT '点赞数',
  `reply_id` char(19) NOT NULL COMMENT '所属评论 ID',
  `reply_nickname` varchar(50) DEFAULT NULL COMMENT '被回复人昵称',
  `reply_user_id` char(19) DEFAULT NULL COMMENT '用户ID（评论发布者ID）',
  `is_deleted` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '逻辑删除 1（true）已删除， 0（false）未删除',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modified` datetime NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `pay_ultra_order` (
  `id` char(19) NOT NULL DEFAULT 'ID',
